    """
    Query Reformulator 3ihsg0da
    ===========================
    Lightweight AI-powered tool designed to summarise unstructured data at scale.
    ...
    APP_NAME    = "Query Reformulator 3ihsg0da"
    APP_VERSION = "1.0.0"
...
return result
    ...
    def build_parser() -> argparse.ArgumentParser:
        p = argparse.ArgumentParser(prog=APP_NAME, description="Lightweight AI-powered tool designed to summarise unstructured data at scale.")
